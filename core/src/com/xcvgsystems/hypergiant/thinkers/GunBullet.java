...
public class GunBullet extends ActorThinker {
	
	//TODO: generalize to Projectile 
	
	final protected ScrollScene CONTEXT;
	final String GRAPHIC_NAME = "GBullet";
	
	final int RADIUS = 5;
	final int DRAW_LAYER = 6;
	final int DRAW_WIDTH = 10;
	final int DRAW_HEIGHT = 10;
	final int DEATH_FRAMES = 2;
	...
	public GunBullet(int x, int y, ScrollScene context) {
